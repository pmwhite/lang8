...
do_clean() {
  rm -f l8c0 l8c1 l8c2
  rm -f examples/hello examples/fib examples/logic examples/struct examples/string examples/i8 examples/bool examples/enum examples/forward examples/null examples/newarr
  rm -f examples/*.s
  rm -rf "$BUILD"
  echo 'cleaned'
}
