...
run_examples_selfhost() {
  ...
  example_compile_fail "$tool" immheapmiss examples/immheapmiss.l8 'missing @immortal'
  example_compile_fail "$tool" immheapbad examples/immheapbad.l8 'unnecessary @immortal'
