...
run_examples_selfhost() {
  ...
  example_compile_fail "$tool" forz examples/forz.l8 'for requires a counted array'
  example_compile_fail "$tool" forint examples/forint.l8 'for requires a counted array'
